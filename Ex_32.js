...
var current_users = ["Ali", "Asad", "Abdulbari", "Adnan", "Taimor", "Imran", "Farhan"];
var new_users = ["ali", "kashif", "burak", "Basit", "farhaN"];
//we will uuse forEach method
new_users.forEach(function (new_user) {
    ...
    if (userNameTaken) {
        console.log("".concat(new_user, " needs to choose a new username becouse  it's already taken"));
    }
    else {
