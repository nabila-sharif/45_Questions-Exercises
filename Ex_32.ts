...
let current_users = ["Ali","Asad","Abdulbari","Adnan","Taimor","Imran","Farhan"];

let new_users = ["ali","kashif","burak","Basit","farhaN"];
...
new_users.forEach(new_user =>{
    ...
    if(userNameTaken){
        console.log(`${new_user} needs to choose a new username becouse  it's already taken`);
    }else{
